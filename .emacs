...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rainbow-mode rainbow org-bullets beacon spacemacs-theme which-key use-package undo-tree solarized-theme neotree magit linum-relative js2-mode highlight-numbers highlight-escape-sequences goto-chg avy ample-theme)))
